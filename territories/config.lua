...
Config.MenuCommand = 'ala'

Config.MinPercentage = 1
...
Config.HackItem = 'laptop_h' -- Item needed to brute force into a stash.

Config.IllegalCurrency = 'black_money' -- Used for the selling of illegal goods.
Config.InProcessCurrency = 'black_money' -- Used for moneywash system.
Config.LegalCurrency = 'money'

Config.MenuType = 'ox' -- muud voimalust pole ka
